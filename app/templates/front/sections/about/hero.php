...
<section class="calltoaction-section calltoaction-section-1">
    ...
    <div class="full-wh bg-cover bg-cc" data-bg="app/templates/front/images/bg2.jpg" style="background-image: url(http://greenlemonmedia.com/projects/builder/elements/images/bg2.jpg); outline-offset: -3px;">
        <b class="full-wh"></b>
    </div>
